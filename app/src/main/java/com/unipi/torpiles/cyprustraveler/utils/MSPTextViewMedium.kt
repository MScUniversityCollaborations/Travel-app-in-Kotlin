 ...
 */
class MSPTextViewMedium(context: Context, attrs: AttributeSet) : AppCompatTextView(context, attrs) {
    ...
    private fun applyFont() {
        ...
        val typeface: Typeface =
            Typeface.createFromAsset(context.assets, "core_sans_cr_55_medium.tff")
